...
@section('body_parts')
    ...
    <div class="row" style="margin-bottom: 40%; margin-top: 5%;">
        ...
        @endif
            ...
            <form action="{{url('updateSchedule',$schedule_id)}}" method="POST">
                @csrf
...
{{--                                Checking if Start Has any value or not. If not, No value set--}}
                                ...
                                <table class="p-2 w-full text-center " style=" border-collapse:separate;border-spacing:0 15px;">
                                    <tr >
                                        <td>
                                            ...
                                            <input type="time" name="fazar_start" id="fazar_start" value="{{$start->fazar}}" class="p-2 ml-4 bg-cyan-300 shadow-xl rounded-lg ">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="time" name="dhuhr_start" id="dhuhr_start" value="{{$start->dhuhr}}" class="p-2 ml-4 bg-cyan-300 shadow-xl rounded-lg ">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label for="asr">Asr</label>
                                            <input type="time" name="asr_start" id="asr_start" value="{{$start->asr}}" class="p-2 ml-8 bg-cyan-300 shadow-xl rounded-lg ">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="time" name="isha_start" id="isha_start" value="{{$start->isha}}" class="p-2 ml-6 bg-cyan-300 shadow-xl rounded-lg ">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="time" name="jummah_start" id="jummah_start" value="{{$start->jummah}}" class="p-2 ml-1 bg-cyan-300 shadow-xl rounded-lg ">
                                        </td>
                                    </tr>
                            ...
                            <table class="p-2 w-full text-center " style=" border-collapse:separate;border-spacing:0 15px;">
                                <tr >
                                    <td>
                                        ...
                                        <input type="time" name="faraz_adhan" id="faraz_adhan" value="{{$adhan->fazar}}" class="p-2 ml-4 bg-cyan-300 shadow-xl rounded-lg ">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="time" name="dhuhr_adhan" id="dhuhr_adhan" value="{{$adhan->dhuhr}}" class="p-2 ml-4 bg-cyan-300 shadow-xl rounded-lg ">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label for="asr_adhan">Asr</label>
                                        <input type="time" name="asr_adhan" id="asr_adhan" value="{{$adhan->asr}}" class="p-2 ml-8 bg-cyan-300 shadow-xl rounded-lg ">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="time" name="isha_adhan" id="isha_adhan" value="{{$adhan->isha}}" class="p-2 ml-6 bg-cyan-300 shadow-xl rounded-lg ">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="time" name="jummah_adhan" id="jummah_adhan" value="{{$adhan->jummah}}" class="p-2 ml-1 bg-cyan-300 shadow-xl rounded-lg ">
                                    </td>
                                </tr>
                            ...
                            <table class="p-2 w-full text-center " style=" border-collapse:separate;border-spacing:0 15px;">
                                <tr >
                                    <td>
                                        ...
                                        <input type="time" name="faraz_jamat" id="faraz_jamat" value="{{$jamat->fazar}}" class="p-2 ml-4 bg-cyan-300 shadow-xl rounded-lg ">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="time" name="dhuhr_jamat" id="dhuhr_jamat"  value="{{$jamat->dhuhr}}" class="p-2 ml-4 bg-cyan-300 shadow-xl rounded-lg ">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label for="asr_jamat">Asr</label>
                                        <input type="time" name="asr_jamat" id="asr_jamat"  value="{{$jamat->asr}}" class="p-2 ml-8 bg-cyan-300 shadow-xl rounded-lg ">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="time" name="isha_jamat" id="isha_jamat" value="{{$jamat->isha}}" class="p-2 ml-6 bg-cyan-300 shadow-xl rounded-lg ">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="time" name="jummah_jamat" id="jummah_jamat"  value="{{$jamat->jummah}}" class="p-2 ml-1 bg-cyan-300 shadow-xl rounded-lg ">
                                    </td>
                                </tr>
                ...
                <div class="buttonDiv text-center mt-6">
                    <button class="btn btn-github w-6/12  " type="submit" id="add">Edit Schedule</button>
